...
public class FenetreReclassification extends JFrame implements ActionListener{
	...
	public FenetreReclassification(){

		//	this.connexion=connexion;
		//nomShape1.clear();

		if(FenetreReclassification.nomShape1.size()==0){
			FenetreReclassification.nomShape1=ConnexionReclassifierRaster.getArrayy();
		}
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreReclassification.nomShape1 = nomShape1;
	}
