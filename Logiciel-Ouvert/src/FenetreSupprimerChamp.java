...
public class FenetreSupprimerChamp extends JFrame implements ActionListener{
	...
	public FenetreSupprimerChamp(){
		...
		if(FenetreSupprimerChamp.nomShape1.size()==0){
			FenetreSupprimerChamp.nomShape1=ConnexionSupprimerChamp.getArrayy();
			FenetreSupprimerChamp.srids=ConnexionSupprimerChamp.getGeomms();
		}
		...
		this.setTitle("Sélectionnez 1 couche");
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreSupprimerChamp.nomShape1 = nomShape1;
	}
	...
	public static void setSrids(ArrayList<String> srids) {
		FenetreSupprimerChamp.srids = srids;
	}
