...
public class RequeteUnionVector2Points extends JFrame implements ActionListener{
	/**
	 * 
	 */
	...
	public static void setComparaison(ArrayList<String> comparaison) {
		RequeteUnionVector2Points.comparaison = comparaison;
	}


	ConnexionBaseDonnees connex;
	public RequeteUnionVector2Points(FenetreVector2Points fen) throws SQLException {
	...
	public static void setSrids(ArrayList<String> srids) {
		RequeteUnionVector2Points.srids = srids;
	}
