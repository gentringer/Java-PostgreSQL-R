...
public class FenetreRenommerRaster extends JFrame implements ActionListener{
	...
	public FenetreRenommerRaster(){
		...
		if(FenetreRenommerRaster.nomShape1.size()==0){
			FenetreRenommerRaster.nomShape1=ConnexionRenommerRaster.getArrayy();
			srids=ConnexionRenommerRaster.getGeomms();
		}
		...
		this.setTitle("Sélectionnez les couches raster à renommer");
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreRenommerRaster.nomShape1 = nomShape1;
	}
	...
	public static void setTableauTailles(ArrayList<String[][]> tableauTailles) {
		FenetreRenommerRaster.tableauTailles = tableauTailles;
	}
	...
	public static void setSrids(ArrayList<String> srids) {
		FenetreRenommerRaster.srids = srids;
	}
