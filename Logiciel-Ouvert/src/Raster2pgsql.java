...
public class Raster2pgsql extends Thread{
...
//	}
	...
	public Raster2pgsql(InsererRaster insert) throws IOException, SQLException, InterruptedException   { 
