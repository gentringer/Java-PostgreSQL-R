...
public class RequeteSupprimerChamp3 {

	RequeteSupprimerChamp3 choixchamps;
	...
	public RequeteSupprimerChamp3() throws SQLException{


	
		Statement stmt = null;

		this.selection=RequeteSupprimerChamp2.getSelection();
			...
			for(String f:selection){
				...
				if (con!=null){
					try{
						...
						String query = "DELETE FROM "+FenetreSupprimerChamp.getNomShape1().get(0)+" WHERE ID =\'"+f+"\'";;
