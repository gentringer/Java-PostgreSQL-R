...
public class FenetreCombinerRaster extends JFrame implements ActionListener{
	...
	public FenetreCombinerRaster(){
		...
		if(FenetreCombinerRaster.nomShape1.size()==0){
			FenetreCombinerRaster.nomShape1=ConnexionCombinerRaster.getArrayy();
			FenetreCombinerRaster.srids=ConnexionCombinerRaster.getGeomms();
		}
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreCombinerRaster.nomShape1 = nomShape1;
	}
	...
	public synchronized void actionPerformed(ActionEvent arg0) {
		...
		RequeteCominerRasterFenetrePixel fenpix = new RequeteCominerRasterFenetrePixel();
		fenpix.setVisible(true);
	...
	public static void setSrids(ArrayList<String> srids) {
		FenetreCombinerRaster.srids = srids;
	}
