...
public class ConnexionSupprimerChamp extends JFrame{
	...
	public static void setArrayy2(ArrayList<String> arrayy2) {
		ConnexionSupprimerChamp.arrayy2 = arrayy2;
	}
	...
	public static void setGeomms2(ArrayList<String> geomms2) {
		ConnexionSupprimerChamp.geomms2 = geomms2;
	}
	...
	public static void setGeomms(ArrayList<String> geomms) {
		ConnexionSupprimerChamp.geomms = geomms;
	}
	...
	public static void setArrayy(ArrayList<String> arrayy) {
		ConnexionSupprimerChamp.arrayy = arrayy;
	}
	...
	public static void setArrayy3(ArrayList<String> arrayy3) {
		ConnexionSupprimerChamp.arrayy3 = arrayy3;
	}

	public ConnexionSupprimerChamp(){
		...
		FenetreSupprimerChamp fensupcham = new FenetreSupprimerChamp();
		fensupcham.setVisible(true);
	...
	public static void setArrayy4(ArrayList<String> arrayy4) {
		ConnexionSupprimerChamp.arrayy4 = arrayy4;
	}
	...
	public static void setGeomms4(ArrayList<String> geomms4) {
		ConnexionSupprimerChamp.geomms4 = geomms4;
	}
