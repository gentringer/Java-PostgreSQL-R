...
public class FenetreExtend extends JFrame implements ActionListener{
	...
	public FenetreExtend(){
		...
		if(FenetreExtend.nomShape1.size()==0){
			FenetreExtend.nomShape1=ConnexionExtend.getArrayy();
			FenetreExtend.srids=ConnexionExtend.getGeomms();
		}
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreExtend.nomShape1 = nomShape1;
	}
