...
public class ConnexionReclassifierRaster extends JFrame{
	...
	public static void setGeomms(ArrayList<String> geomms) {
		ConnexionReclassifierRaster.geomms = geomms;
	}
	...
	public static void setArrayy(ArrayList<String> arrayy) {
		ConnexionReclassifierRaster.arrayy = arrayy;
	}

	public ConnexionReclassifierRaster(){
		...
		FenetreReclassification fenereclass = new FenetreReclassification();
		fenereclass.setVisible(true);
	}
