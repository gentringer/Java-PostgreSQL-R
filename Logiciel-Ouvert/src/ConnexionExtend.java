...
public class ConnexionExtend extends JFrame{
	...
	public static void setArrayy2(ArrayList<String> arrayy2) {
		ConnexionExtend.arrayy2 = arrayy2;
	}
	...
	public static void setGeomms2(ArrayList<String> geomms2) {
		ConnexionExtend.geomms2 = geomms2;
	}
	...
	public static void setArrayy3(ArrayList<String> arrayy3) {
		ConnexionExtend.arrayy3 = arrayy3;
	}

	public ConnexionExtend(){
		...
		FenetreExtend fenex = new FenetreExtend();
		fenex.setVisible(true);
	...
	public static void setArrayy4(ArrayList<String> arrayy4) {
		ConnexionExtend.arrayy4 = arrayy4;
	}
	...
	public static void setGeomms4(ArrayList<String> geomms4) {
		ConnexionExtend.geomms4 = geomms4;
	}
