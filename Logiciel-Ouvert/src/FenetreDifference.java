...
public class FenetreDifference extends JFrame implements ActionListener{
	...
	public FenetreDifference(){
		...
		if(FenetreDifference.nomShape1.size()==0){
			FenetreDifference.nomShape1=ConnexionDifference.getArrayy();
			FenetreDifference.srids=ConnexionDifference.getGeomms();
		}
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreDifference.nomShape1 = nomShape1;
	}
