...
public class ConnexionDifference extends JFrame{
	...
	public static void setArrayy2(ArrayList<String> arrayy2) {
		ConnexionDifference.arrayy2 = arrayy2;
	}
	...
	public static void setGeomms2(ArrayList<String> geomms2) {
		ConnexionDifference.geomms2 = geomms2;
	}
	...
	public static void setGeomms(ArrayList<String> geomms) {
		ConnexionDifference.geomms = geomms;
	}
	...
	public static void setArrayy(ArrayList<String> arrayy) {
		ConnexionDifference.arrayy = arrayy;
	}
	...
	public static void setArrayy3(ArrayList<String> arrayy3) {
		ConnexionDifference.arrayy3 = arrayy3;
	}

	public ConnexionDifference(){
		...
		FenetreDifference fendiff = new FenetreDifference();
		fendiff.setVisible(true);
	...
	public static void setArrayy4(ArrayList<String> arrayy4) {
		ConnexionDifference.arrayy4 = arrayy4;
	}
	...
	public static void setGeomms4(ArrayList<String> geomms4) {
		ConnexionDifference.geomms4 = geomms4;
	}
