...
public class FenetreIntersection extends JFrame implements ActionListener{
	...
	public FenetreIntersection(){
		...
		if(FenetreIntersection.nomShape1.size()==0){
			FenetreIntersection.nomShape1=ConnexionIntersection.getArrayy();
			FenetreIntersection.srids=ConnexionIntersection.getGeomms();
		}
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreIntersection.nomShape1 = nomShape1;
	}
	...
	public synchronized void actionPerformed(ActionEvent arg0) {
		...
		if(nomShape1.size()==2){
			...
			System.out.println("Sélection seulement deux couches!");
		}
	}
	...
	public static void setSrids(ArrayList<String> srids) {
		FenetreIntersection.srids = srids;
	}
