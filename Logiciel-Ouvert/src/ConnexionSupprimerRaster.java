...
public class ConnexionSupprimerRaster extends JFrame{
	...
	public static void setGeomms2(ArrayList<String> geomms2) {
		ConnexionSupprimerRaster.geomms2 = geomms2;
	}
	...
	public static void setArrayy2(ArrayList<String> arrayy2) {
		ConnexionSupprimerRaster.arrayy2 = arrayy2;
	}
	...
	public static void setArrayy(ArrayList<String> arrayy) {
		ConnexionSupprimerRaster.arrayy = arrayy;
	}

	public ConnexionSupprimerRaster(){
		...
		FenetreSupprimerRaster fenesup = new FenetreSupprimerRaster();
	...
	public static void setGeomms(ArrayList<String> geomms) {
		ConnexionSupprimerRaster.geomms = geomms;
	}
