...
public class FenetreRaster extends JFrame implements ActionListener{
	...
	public static void setTaillesPixel(ArrayList<String[][]> taillesPixel) {
		FenetreRaster.taillesPixel = taillesPixel;
	}
	...
	private static ArrayList <String> taillesdesPixel = new ArrayList <String> ();
	private static ArrayList <String> taillesdesPixel2 = new ArrayList <String> ();
	...
	public FenetreRaster(){
		...
		if(DensitePopulation.getTaillesPixel2().size()>0){
			FenetreRaster.taillesPixel=DensitePopulation.getTaillesPixel2();
			FenetreRaster.srids=DensitePopulation.getSrids();
		}



		System.out.println("print fenetre raster taille size"+FenetreRaster.taillesPixel.size());
		...
		if(FenetreRaster.nomShape1.size()==0){
			FenetreRaster.nomShape1=ConnexionRaster.getArrayy();
			FenetreRaster.srids1=ConnexionRaster.getGeomms();
			FenetreRaster.nomShape2=ConnexionRaster.getArrayy2();
			FenetreRaster.srids2=ConnexionRaster.getGeomms2();
		}
		else{
			...
			if(FenetreRaster.nomShape1.size()>0){
				FenetreRaster.getNomShape1().removeAll(FenetreRaster.getNomShape1());
				FenetreRaster.getNomShape1().addAll(ConnexionRaster.getArrayy());
				FenetreRaster.getSrids1().removeAll(FenetreRaster.getSrids1());
				FenetreRaster.getSrids1().addAll(ConnexionRaster.getGeomms());
			}
		}



		if(FenetreRaster.getNomShape2().size()>0){
			FenetreRaster.getNomShape2().removeAll(FenetreRaster.getNomShape2());
			FenetreRaster.getNomShape2().addAll(ConnexionRaster.getArrayy());
			FenetreRaster.getSrids2().removeAll(FenetreRaster.getSrids2());
			FenetreRaster.getSrids2().addAll(ConnexionRaster.getGeomms());
		}
		...
		FenetreRaster.nomShape1.removeAll(nomCouche);
	...
	public static void setNomShape(ArrayList<String> nomShape) {
		FenetreRaster.nomShape = nomShape;
	}
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreRaster.nomShape1 = nomShape1;
	}
	...
	public static void setNomTaillePixel(ArrayList<String> nomTaillePixel) {
		FenetreRaster.nomTaillePixel = nomTaillePixel;
	}
	...
	public static void setLestaillesdespixel(ArrayList<String> lestaillesdespixel) {
		FenetreRaster.lestaillesdespixel = lestaillesdespixel;
	}
	...
	public static void setNomCouche(ArrayList<String> nomCouche) {
		FenetreRaster.nomCouche = nomCouche;
	}
	...
	public static void setNomShape2(ArrayList<String> nomShape2) {
		FenetreRaster.nomShape2 = nomShape2;
	}
	...
	public static void setTableauTailles(ArrayList<String[][]> tableauTailles) {
		FenetreRaster.tableauTailles = tableauTailles;
	}

	public static ArrayList<String> getTaillesdesPixel() {
		return taillesdesPixel;
	}

	public static void setTaillesdesPixel(ArrayList<String> taillesdesPixel) {
		FenetreRaster.taillesdesPixel = taillesdesPixel;
	}

	public static ArrayList<String> getTaillesdesPixel2() {
		return taillesdesPixel2;
	}

	public static void setTaillesdesPixel2(ArrayList<String> taillesdesPixel2) {
		FenetreRaster.taillesdesPixel2 = taillesdesPixel2;
	}
