...
public class RequeteSupprimerRaster extends JFrame implements ActionListener{
	/**
	 * 
	 */
	FenetreRaster fen;
	...
	public RequeteSupprimerRaster() throws SQLException {

		nomCouches=FenetreSupprimerRaster.getNomShape1();
