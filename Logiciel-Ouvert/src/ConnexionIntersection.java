...
public class ConnexionIntersection extends JFrame{
	...
	public static void setArrayy2(ArrayList<String> arrayy2) {
		ConnexionIntersection.arrayy2 = arrayy2;
	}
	...
	public static void setGeomms2(ArrayList<String> geomms2) {
		ConnexionIntersection.geomms2 = geomms2;
	}
	...
	public static void setGeomms(ArrayList<String> geomms) {
		ConnexionIntersection.geomms = geomms;
	}
	...
	public static void setArrayy(ArrayList<String> arrayy) {
		ConnexionIntersection.arrayy = arrayy;
	}
	...
	public static void setArrayy3(ArrayList<String> arrayy3) {
		ConnexionIntersection.arrayy3 = arrayy3;
	}

	public ConnexionIntersection(){
		...
		FenetreIntersection feninter = new FenetreIntersection();
		feninter.setVisible(true);
	...
	public static void setArrayy4(ArrayList<String> arrayy4) {
		ConnexionIntersection.arrayy4 = arrayy4;
	}
	...
	public static void setGeomms4(ArrayList<String> geomms4) {
		ConnexionIntersection.geomms4 = geomms4;
	}
