...
public class ConnexionExporterVecteurs extends JFrame{
	...
	public static void setGeomms(ArrayList<String> geomms) {
		ConnexionExporterVecteurs.geomms = geomms;
	}
	...
	public static void setArrayy(ArrayList<String> arrayy) {
		ConnexionExporterVecteurs.arrayy = arrayy;
	}

	public ConnexionExporterVecteurs(){
