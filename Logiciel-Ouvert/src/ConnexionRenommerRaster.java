...
public class ConnexionRenommerRaster extends JFrame{
	...
	public static void setArrayy2(ArrayList<String> arrayy2) {
		ConnexionRenommerRaster.arrayy2 = arrayy2;
	}
	...
	public static void setGeomms2(ArrayList<String> geomms2) {
		ConnexionRenommerRaster.geomms2 = geomms2;
	}
	...
	public static void setGeomms(ArrayList<String> geomms) {
		ConnexionRenommerRaster.geomms = geomms;
	}
	...
	public static void setArrayy(ArrayList<String> arrayy) {
		ConnexionRenommerRaster.arrayy = arrayy;
	}
	...
	public static void setArrayy3(ArrayList<String> arrayy3) {
		ConnexionRenommerRaster.arrayy3 = arrayy3;
	}

	public ConnexionRenommerRaster(){
		...
		FenetreRenommerRaster fenrenom = new FenetreRenommerRaster();
		fenrenom.setVisible(true);
	...
	public static void setArrayy4(ArrayList<String> arrayy4) {
		ConnexionRenommerRaster.arrayy4 = arrayy4;
	}
	...
	public static void setGeomms4(ArrayList<String> geomms4) {
		ConnexionRenommerRaster.geomms4 = geomms4;
	}
