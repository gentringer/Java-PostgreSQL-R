...
public class FenetreUnion extends JFrame implements ActionListener{
	...
	public FenetreUnion(){
		...
		if(FenetreUnion.nomShape1.size()==0){
			FenetreUnion.nomShape1=ConnexionUnion.getArrayy();
			FenetreUnion.srids=ConnexionUnion.getGeomms();
		}
	...
	public static void setNomShape1(ArrayList<String> nomShape1) {
		FenetreUnion.nomShape1 = nomShape1;
	}
	...
	public synchronized void actionPerformed(ActionEvent arg0) {
		...
		if(nomShape1.size()==2||nomShape1.size()==1){
